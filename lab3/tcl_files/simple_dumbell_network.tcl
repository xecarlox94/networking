...
$tcpsrc set fid_ 1$tcpsrc set segsize_ 1460; # default packet size
...
$ns_ trace-queue $r(1) $n(1) $trq_dst1_# trace all packet events between the two routers
...
$ns_ at $end "finish"; # end of simulation# output progress
